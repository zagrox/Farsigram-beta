...
interface CampaignFilterComponentProps {
  filters: CampaignFilterState;
  onFilterChange: (newFilters: Partial<CampaignFilterState>) => void;
  categories: ApiItem[];
  locations: ApiItem[];
  audiences: ApiItem[];
...
// --- Main Component ---
const CampaignFilterComponent: React.FC<CampaignFilterComponentProps> = ({
  filters,
  onFilterChange,
  categories,
  locations,
