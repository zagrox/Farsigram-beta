...
const FilterDropdown: React.FC<{
  ...
  <div className="relative flex-1 min-w-[150px]">
    <select
      ...
      onChange={onChange}
      disabled={disabled}
      className="w-full appearance-none bg-neutral-100 dark:bg-neutral-800 border-none rounded-md py-2 px-3 text-sm text-neutral-800 dark:text-neutral-200 focus:outline-none focus:ring-2 focus:ring-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
    >
